...
public class GUI_KhachHang extends JFrame implements ActionListener {

	private JPanel contentPane;
	private JTextField txtMaKH, txtTenKH, txtEmailKH, txtSDTKH, txtCMND, txtTimKiem, txtNgaySinhKH, txtTuoiKH,
			txtDiaChiKH;
	private JButton btnQLKH, btnQLDV, btnTCHD, btnQLP, btnQLNV, btnLogout, btnBack, btnThem, btnXoa, btnSua, btnLamMoi,
			btnReload, btnTimKiem;
	...
	public GUI_KhachHang() {
		...
		btnQLDV.setBounds(26, 360, 200, 30);
		...
		btnTCHD.setBounds(26, 406, 200, 30);
		...
		btnLogout.setBounds(26, 602, 200, 30);
		panel.add(btnLogout);
		...
		btnBack.setBounds(26, 450, 200, 30);
		...
		panel_1.setBounds(246, 0, 365, 678);
		...
		btnThem.setBounds(20, 531, 159, 32);
		panel_1.add(btnThem);
		...
		btnSua.setBounds(189, 531, 159, 32);
		panel_1.add(btnSua);
		...
		btnXoa.setBounds(20, 573, 159, 32);
		panel_1.add(btnXoa);
		...
		btnLamMoi.setBounds(191, 573, 159, 32);
		...
		scrollPane.setBounds(609, 66, 777, 610);
		...
		// Sự kiện lấy mã nhân viên trong comboBox đưa vào JTextField
		comboBoxMaKH.addItemListener(new ItemListener() {
			@Override
			public void itemStateChanged(ItemEvent e) {
				if (e.getStateChange() == ItemEvent.SELECTED) { // Nếu phần tử được chọn
					String selectValue = comboBoxMaKH.getSelectedItem().toString(); // Lấy giá trị phần tử được chọn lưu
																					// vào biến selectValue
					txtTimKiem.setText(selectValue); // setText
				}
			}
		});
	}
...
//						table.setValueAt(txtDiaChiKH.getText(), row, 8);
	...
	private void updateTableData() {
		// Xóa tất cả các dòng (dữ liệu) hiện tại trong table
